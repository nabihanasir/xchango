    ...
    <div className="flex h-screen overflow-hidden font-sans relative">
      ...
      >
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {!collapsed && isActive && <ChevronRight className="h-4 w-4 ml-auto opacity-50" />}
              </Link>
            );
          })}
        </nav>
        ...
        <div className="p-4 border-t border-white/5 space-y-2">
          <button onClick={() => setCollapsed(!collapsed)} className="w-full flex items-center gap-4 px-4 py-3.5 rounded-xl text-white/40 hover:text-white hover:bg-white/5 transition-all outline-none">
          ...
          <Link to="/login" className="flex items-center gap-4 px-4 py-3.5 rounded-xl text-white/40 hover:text-red-400 hover:bg-red-400/10 transition-all">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        <header className="h-24 bg-white/70 backdrop-blur-xl border-b border-light-color/60 flex items-center justify-between px-6 lg:px-10 z-20 sticky top-0 shrink-0">
          <div className="flex items-center gap-4 lg:gap-8">
            <button className="lg:hidden p-2 text-dark-blue bg-light-color/40 rounded-lg" onClick={() => setIsMobileMenuOpen(true)}>
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto p-6 lg:p-10 custom-scrollbar relative z-10">
