...
router.get('/student/requests', authorizeRoles(UserRole.STUDENT), courseEquivalencyController.getStudentRequests);
router.post('/student/requests', authorizeRoles(UserRole.STUDENT), courseEquivalencyController.createStudentRequest);
