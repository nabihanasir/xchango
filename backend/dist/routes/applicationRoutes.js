...
router.post('/', (0, authorize_1.authorizeRoles)(User_1.UserRole.STUDENT), workflowAccess_1.requireCompleteStudentProfile, applicationController.createApplication);
...
router.patch('/:id/complete-interview', (0, authorize_1.authorizeRoles)(User_1.UserRole.ADVISOR), applicationController.completeInterview);
